AUTH_LOGIN_FORM = 'Auth_login__3hAey'  # Форма входа
HEADER_NAV_PANEL = 'AppHeader_header__nav__g5hnF'  # Верхняя горизонтальная навигационная панель сайта
LOGO_STELLAR_BURGERS = './/div[@class="AppHeader_header__logo__2D0X2"]/a'  # Логотип сайта
...
BUTTON_CONSTRUCTOR = ('.//p[@class="AppHeader_header__linkText__3q_va ml-2"][text('
                      ')="Конструктор"]/parent::a')
